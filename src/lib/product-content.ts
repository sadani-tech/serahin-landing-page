...
export const roadmap = [
  {
    ...
    title: "Fondasi operasional PO",
    description:
      "Kampanye, keranjang multi-varian, pesanan, DP dan pelunasan, portal pembeli, timeline, vendor, CMS, import, export, serta design system.",
    items: ["Kelola PO end-to-end", "Portal self-service", "Data & laporan"],
  },
  {
    version: "PRD v2.0",
    status: "Direncanakan",
  ...
  },
  {
    ...
    description:
      "Onboarding seller, katalog lintas-seller, isolasi data, dan dashboard pengawasan untuk Platform Owner.",
    items: ["Seller onboarding", "Katalog publik", "Kontrol Platform Owner"],
  },
];
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Keduanya tercantum sebagai roadmap berdasarkan PRD v2.0 dan v3.0 yang masih berstatus draft. Landing page sengaja membedakannya dari kemampuan v1.0–v1.9 yang sudah menjadi fondasi aplikasi.",
  },
  {
